...
namespace torc::models {
    class ContactModel {
    public:
        virtual RobotStateDerivative GetDynamics(const RobotState& state, const vectorx_t& input,
                                                       const RobotContactInfo& contact_info) = 0;

        virtual void DynamicsDerivative(const RobotState& state,
                                        const vectorx_t& input, const RobotContactInfo& contacts,
